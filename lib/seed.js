...
const DEFAULT_SETTINGS = {
  ...
  // Șabloane email — text editabil, redat automat într-un layout HTML cu logo.
  // Aceleași token-uri ca la SMS. „body" acceptă mai multe rânduri (paragrafe).
  emailTemplates: {
    ...
    ownerBody:
      'Ați primit o comandă nouă {number} de la {name}{company}.\n\nTotal: {total} lei · Livrare în {city}\nTelefon client: {phone}',
    invoiceEmailEnabled: true, // comutator principal: trimiterea facturilor pe email
    attachInvoice: true,       // atașare automată la emailul de confirmare (doar dacă cel de sus e activ)
