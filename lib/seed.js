...
const DEFAULT_SETTINGS = {
  ...
  // Integrare mesaje (Twilio), dacă e completată aici, are prioritate față de
  // variabilele de mediu TWILIO_*. Lăsați goală pentru a folosi variabilele de mediu.
  twilio: {
    // Comutator general: cât timp e oprit, mesajele rulează în mod simulat
    // (doar în jurnal), chiar dacă datele Twilio sunt completate. Implicit
    // OPRIT până la aprobarea expeditorului.
    enabled: false,
    // Canalul de trimitere: 'sms' sau 'whatsapp' (WhatsApp folosește același
    // API Twilio, cu numerele prefixate cu whatsapp:).
    channel: 'sms',
    accountSid: '',
    authToken: '',
    fromNumber: '',
...
const SETTINGS_SCHEMA = {
  ...
  vatRate: 'number',
  twilio: 'object', efactura: 'object', maps: 'object', postmark: 'object', marketing: 'object',
